...
#define EVT_ENTER_QUEUE1 4
#define EVT_LEAVE_QUEUE1 5
#define EVT_SEIZE_SERVER1 6
#define EVT_RELEASE_SERVER1 7
#define EVT_ENTER_QUEUE2 8
#define EVT_LEAVE_QUEUE2 9
#define EVT_SEIZE_SERVER2 10
#define EVT_RELEASE_SERVER2 11
#define EVT_EXIT_SYSTEM 12 
// exitUsage control
...
void release(Simulation simulation,Event event,Queue queue,Server sever);
int queueUp1andSeize(Simulation simulation, Event event, Queue queue, Server server);
int queueUp2andSeize(Simulation simulation, Event event, Queue queue, Server server);
